...
public class MedicalRecordsControllerTest {
    ...
    public void givenFirstNameAndLastName_whenGetAMedicalRecord_then404IsReceived() throws Exception {
        ...
        when(medicalRecordService.getMedicalRecords("Jon", "Boyd")).thenThrow(new NotFoundException("MedicalRecords not found with this name"));
        ...
        Assertions.assertThatThrownBy(() ->
                ...
                .hasCause(new NotFoundException("MedicalRecords not found with this name"));
    ...
    public void givenNameThatDontExist_whenDeleteAMedicalRecord_then404IsReceived() throws Exception
    {
        ...
        doThrow(new NotFoundException("MedicalRecords not found with this name")).when(medicalRecordService).deleteAccount("Jon", "Boyd");
    ...
    public void givenMedicalRecord_whenUpdateAMedicalRecord_then404IsReceived() throws Exception {
        ...
        // when
        doThrow(new NotFoundException("MedicalRecords not found with this name")).when(medicalRecordService).updateMedicalRecords(any(MedicalRecords.class), anyString(), anyString());
