...
public class PersonsControllerTest {
    ...
    public void givenPerson_whenGetAPerson_then404IsReceived() throws Exception {
        ...
        when(personsService.getPersons("Jon", "Boyd")).thenThrow(NotFoundException.class);
    ...
    public void givenPersonThatDontExist_whenDeleteAPerson_then404IsReceived() throws Exception
    {
        ...
        doThrow(NotFoundException.class).when(personsService).deleteAccount("Jon", "Boyd");
    ...
    public void givenPerson_whenUpdateAPerson_then404IsReceived() throws Exception {
        ...
        // when
        doThrow(NotFoundException.class).when(personsService).updatePerson(any(Persons.class),anyString(), anyString());
